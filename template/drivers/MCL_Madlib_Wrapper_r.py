...
class MCL_Nanodrive:
    ...
    def __init__(self):
        ...
        #self.handle = self.init_handle() # ommented by Rolando for joint MCL/µM method 4/29/2026.
    ...
    def get_handle(self):
        """Return the persistent NanoDrive handle owned by this driver instance."""
        if not hasattr(self, "handle") or self.handle in (None, 0, ""):
            try:
                self.handle = self.init_handle_or_get_existing()
            except Exception:
