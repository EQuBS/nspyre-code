...
#nano = gw.nano # Commented by Rolando 4/27/2026 to test the µM method # This is the proxy to your NanoDriver or MCL_Nanodrive on the instrument server
        ...
        main_widget = MainWidget(
            {
                ...
                'Subsystems': MainWidgetItem(nspyre.gui.widgets.subsystem, 'SubsystemsWidget', args=[insmgr.subs.subsystems], stretch=(1, 1)),
                 ...
                 #'New Nano': MainWidgetItem(template.gui.gui_Nano3, 'NanoWidget', args=[nano], stretch=(1, 1)), # Commented to test µM, Rolando 4/27/2026
                'µM Nano': MainWidgetItem(template.gui.gui_Nano3_mm, 'NanoWidget', stretch=(1, 1)),
                 ...
                 #'2D-Scan': MainWidgetItem(template.gui.gui_2D_Scan, 'TwoD_Scan', stretch=(1, 1)), # Commented to test µM, Rolando 4/27/2026
                'µM Scan': MainWidgetItem(template.gui.gui_2D_Scan_mm, 'TwoD_Scan_mm', stretch=(1, 1)),
